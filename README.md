...
- ⚔️ **Live Combat vs. Exploration Detection**: Accurately switches between `⚔️ In Combattimento` (`In Combat`) and `🧭 In Esplorazione` (`Exploring`) the exact moment you enter or exit turn-based battles.
